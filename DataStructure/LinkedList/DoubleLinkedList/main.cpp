#include "NormalDoubleLinkedList.h"
#include "RecursiveDoubleLinkedList.h"

int main(void)
{
  // NormalDoubleLinkedList<char> * const list { new NormalDoubleLinkedList<char> { } } ;
  RecursiveDoubleLinkedList<char> * const list { new RecursiveDoubleLinkedList<char> { } } ;
